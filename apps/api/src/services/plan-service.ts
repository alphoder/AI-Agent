...
import {
  ...
  PLAN_TASK_TYPES, JOURNEY_PLAN_LIMIT_PER_MONTH, JOURNEY_PASS_SCORE,
...
export async function generatePlan(
  ...
  const plan: JourneyPlan = { headline: clean(raw.headline, 120), days, kind };
